...
import {
  ...
  export async function getServerSideProps({ params }) {
    ...
    const getAnnonceRequest = await fetch('http://localhost:1337/annonces/' + params.updateParking);
    let annonce = await getAnnonceRequest.json();
  ...
  export default function UpdateParking({ marques, annonce, transmisions }) {
